...
save(my_mod, file = "~/YOUR_DIRECTORY/Desk.RData", compress = "xz")
...
write.table(tempdf,"~/YOUR_DIRECTORY/Desk_ATES.csv", row.names = F, append=T, sep = ",", col.names=F)
