...
#Fit multivariate BCF to the data
my_mod <- fast_bart(X, 
                    Y, 
                    Z, 
                    X2,
...
save(my_mod, file = "~/your_directory/DeskRevisions1.RData", compress = "xz")
...
#bartCause applied to TIMSS (univariate BART)
...
write.table(tempdf,"~/your_directory/other_ates_desk.csv", row.names = F, append=T, sep = ",", col.names=F)
